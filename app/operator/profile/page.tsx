              ...
              <form onSubmit={handleSave} className="space-y-5 flex-1 flex flex-col justify-between">
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input type="email" name="email" value={formData.email} onChange={handleChange} disabled={!isEditing || loading} className={`bg-gray-50/50 border-gray-200 focus:bg-white focus:ring-blue-500 transition-colors ${isEditing ? "border-blue-300 bg-white" : ""}`} placeholder="nama@perusahaan.com" required />
                  </div>
